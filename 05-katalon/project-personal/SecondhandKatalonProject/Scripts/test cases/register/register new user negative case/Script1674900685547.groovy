...
Mobile.callTestCase(findTestCase('Test Cases/page/register page/input user data'), [('email') : 'syariful21@mail.com'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Test Cases/page/register page/apply registration'), null, FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Test Cases/page/register page/verify failed to register'), null, FailureHandling.STOP_ON_FAILURE)
